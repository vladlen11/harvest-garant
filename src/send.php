...
//    die;
    ...
    if (isset($_POST['submit'])) {
        ...
        //$to = "vladlen11.89@gmail.com"; // Здесь нужно написать e-mail, куда будут приходить письма
        $to = "wegolo8733@winmails.net"; // Здесь нужно написать e-mail, куда будут приходить письма
